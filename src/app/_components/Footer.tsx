...
const Footer = () => {
  return (
    <section className="relative overflow-hidden flex flex-wrap bg-white py-1">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <Link href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 transition-colors duration-300 ease-in-out hover:bg-orange-400 hover:border-orange-400">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"
